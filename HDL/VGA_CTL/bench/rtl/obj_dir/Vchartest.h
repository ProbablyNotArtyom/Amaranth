...
VL_MODULE(Vchartest) {
  public:
    ...
    // Begin mtask footprint  all: 
    VL_SIG8(chartest__DOT__vga_interface_0__DOT__pixclk,0,0);
    ...
    VL_SIG8(chartest__DOT__vga_interface_0__DOT__scroll_reg_y,7,0);
    VL_SIG8(chartest__DOT__vga_interface_0__DOT__scroll_reg_x,7,0);
    ...
    // Internals; generally not touched by application code
    // Begin mtask footprint  all: 
    VL_SIG8(__VinpClk__TOP__chartest__DOT__vga_interface_0__DOT__pixclk,0,0);
    VL_SIG8(__Vclklast__TOP__i_clk,0,0);
    VL_SIG8(__Vclklast__TOP____VinpClk__TOP__chartest__DOT__vga_interface_0__DOT__pixclk,0,0);
    VL_SIG8(__Vclklast__TOP__i_reset,0,0);
    VL_SIG8(__Vchglast__TOP__chartest__DOT__vga_interface_0__DOT__pixclk,0,0);
...
#endif // VL_DEBUG
  public:
    static void _eval_initial(Vchartest__Syms* __restrict vlSymsp);
    static void _eval_settle(Vchartest__Syms* __restrict vlSymsp);
    static void _initial__TOP__1(Vchartest__Syms* __restrict vlSymsp);
    static void _multiclk__TOP__6(Vchartest__Syms* __restrict vlSymsp);
    ...
    static void _settle__TOP__4(Vchartest__Syms* __restrict vlSymsp);
    ...
    static void traceFullThis(Vchartest__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    static void traceFullThis__1(Vchartest__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    static void traceInitThis(Vchartest__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    static void traceInitThis__1(Vchartest__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
