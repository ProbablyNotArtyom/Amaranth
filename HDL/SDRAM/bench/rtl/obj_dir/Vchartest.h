...
VL_MODULE(Vchartest) {
  public:
    ...
    // Begin mtask footprint  all: 
    VL_SIG8(chartest__DOT__vga_interface_0__DOT__clk_50mhz,0,0);
    ...
    // Internals; generally not touched by application code
    // Begin mtask footprint  all: 
    VL_SIG8(__VinpClk__TOP__chartest__DOT__vga_interface_0__DOT__clk_50mhz,0,0);
    VL_SIG8(__Vclklast__TOP__i_pixclk,0,0);
    VL_SIG8(__Vclklast__TOP__i_clk,0,0);
    VL_SIG8(__Vclklast__TOP__i_reset,0,0);
    VL_SIG8(__Vclklast__TOP____VinpClk__TOP__chartest__DOT__vga_interface_0__DOT__clk_50mhz,0,0);
    VL_SIG8(__Vchglast__TOP__chartest__DOT__vga_interface_0__DOT__clk_50mhz,0,0);
  ...
  public:
    ...
    static void _initial__TOP__4(Vchartest__Syms* __restrict vlSymsp);
    static void _sequent__TOP__1(Vchartest__Syms* __restrict vlSymsp);
    ...
    static void _settle__TOP__5(Vchartest__Syms* __restrict vlSymsp);
